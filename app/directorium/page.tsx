...
export default function DirectoriumPage() {
  ...
  return (
    <div className="relative -mx-4 -my-6 h-[calc(100vh-9rem)] overflow-hidden rounded-2xl border border-cyan-400/15 bg-[#050A1A] sm:-mx-6 md:-mx-10 md:-my-10 md:h-[calc(100vh-7rem)]">
      <HiveScene
